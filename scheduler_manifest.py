...
JOB_GRAPH: dict[str, dict] = {
    ...
    "intraday_orchestrator_job":      {"label": "Crash & Moonshot Alerts",                        "category": "intraday",    "engine": "intraday_orchestrator.py",      "produces": ["intraday_parquet", "market_pulse_cache", "account_performance_cache"],  "consumes": ["yahoo_price_data"],                                                 "settings_anchor": "crash-moonshot-card"},
