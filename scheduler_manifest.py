...
JOB_GRAPH: dict[str, dict] = {
    ...
    "trading_accounts_node":          {"label": "Trading Account(s)",                             "category": "manual",      "engine": "accounts_engine.py",            "produces": ["portfolio"],                                                  "consumes": ["manual_account_entries"],                                           "non_job": True, "settings_anchor": None},
    ...
    "quant_analysis_job":             {"label": "Quantamental Analysis Engine",                   "category": "quant",       "engine": "quant_signals.py",              "produces": ["historical_parquet", "stock_signals", "quant_signals", "market_regimes", "macro_regimes"], "consumes": ["portfolio", "macro_indicators", "yahoo_price_data"], "settings_anchor": "automation-schedulers-card"},
    ...
    "morning_briefing_dispatch_job":  {"label": "Quant Briefing Generator & Notifications (Morning)",   "category": "briefing", "engine": "report_dispatcher.py",     "produces": [],                                                             "consumes": ["quant_signals", "stock_signals", "market_regimes", "sentiment", "ml_predictions"], "settings_anchor": "alerts-briefings-card"},
    "lunchtime_briefing_dispatch_job":{"label": "Quant Briefing Generator & Notifications (Lunchtime)", "category": "briefing", "engine": "report_dispatcher.py",   "produces": [],                                                             "consumes": ["quant_signals", "stock_signals", "market_regimes", "sentiment"],    "settings_anchor": "alerts-briefings-card"},
    "intraday_orchestrator_job":      {"label": "Crash & Moonshot Alerts",                        "category": "intraday",    "engine": "intraday_orchestrator.py",      "produces": ["intraday_parquet"],                                           "consumes": ["yahoo_price_data"],                                                 "settings_anchor": "crash-moonshot-card"},
    "intraday_dip_scan_job":          {"label": "Dip Radar — Intraday Bottom Finder",             "category": "intraday",    "engine": "intraday_bottom_engine.py",     "produces": ["intraday_monitor_results"],                                   "consumes": ["intraday_parquet"],                                                 "settings_anchor": "dip-radar-settings-card"},
