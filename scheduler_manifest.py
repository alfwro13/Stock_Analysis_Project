...
JOB_GRAPH: dict[str, dict] = {
    ...
    "earnings_vol_retry_job":         {"label": "Earnings Volatility Retry",                      "category": "quant",       "engine": "earnings_vol_engine.py",        "produces": ["earnings_volatility"],                                        "consumes": ["historical_parquet", "yahoo_price_data"],                           "settings_anchor": "automation-schedulers-card"},
