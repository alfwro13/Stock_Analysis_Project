...
JOB_GRAPH: dict[str, dict] = {
    ...
    "ghostfolio_sync_job":            {"label": "Ghostfolio Sync",                                "category": "data",        "engine": "ghostfolio_sync.py",            "produces": ["portfolio"],                                                  "consumes": [],                                                                   "settings_anchor": "automation-schedulers-card"},
