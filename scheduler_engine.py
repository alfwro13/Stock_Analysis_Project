...
JOB_GRAPH: dict[str, dict] = {
    ...
    "quant_analysis_job":           {"label": "Quant Analysis Pipeline",    "category": "quant",       "engine": "quant_signals.py",              "produces": ["historical_parquet", "stock_signals", "quant_signals", "market_regimes", "macro_regimes"], "consumes": ["portfolio", "macro_indicators"]},
