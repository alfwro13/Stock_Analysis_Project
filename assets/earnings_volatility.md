...
**Why?**
1. **Extreme API Load:** For a single stock, the engine must make multiple sequential queries: fetching the options chain, fetching the historical earnings calendar, and fetching multiple historical price slices to measure past gaps. Running this 4,000 times would result in a permanent IP ban from our data providers.
