...
<p>A second, independent instance of the referee — the <strong>Cross-Engine Alert Referee</strong> — scores the combined Pillar Confluence / Regime-Weighted Conviction Score signal itself, trained on every already-resolved historical call from both the Market Trap &amp; Recovery Monitor and Pattern Detection. It has its own model, training schedule, and Shadow/Active readiness, entirely independent of the original Trap Monitor pilot above — enabling one has no effect on the other.</p>""",
    },
    {
