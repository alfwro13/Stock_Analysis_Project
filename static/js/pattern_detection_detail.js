...
const PD_PATTERN_COLORS = {
    ...
    ascending: '#f1c40f',
    descending: '#9b59b6',
    symmetrical_triangle: '#95a5a6',
    symmetrical_triangle_bullish: '#1abc9c',
    symmetrical_triangle_bearish: '#c0392b',
    rising_wedge: '#e67e22',
    falling_wedge: '#2980b9',
...
const PD_PATTERN_EXPLANATIONS = {
    ...
    bull_pennant: "A Bull Pennant forms after the same kind of sharp rally as a Bull Flag, but the pause afterward is a tight, narrowing triangle rather than a parallel channel. It suggests early buyers are taking profit while the range compresses, and a break back above the triangle is read as a signal the rally is resuming.",
    bear_pennant: "A Bear Pennant forms after a sharp decline, followed by a tight, narrowing triangle rather than a parallel channel. It suggests the pause is short-covering rather than a genuine reversal, and a break back below the triangle is read as a signal the decline is resuming.",
    ...
    symmetrical_triangle: "A Symmetrical Triangle forms when a stock's price swings narrow steadily — each high a little lower than the last, each low a little higher — as a falling resistance line and a rising support line converge. It reflects growing indecision between buyers and sellers rather than either side clearly winning, and direction isn't known yet at this stage: a breakout in either direction is often explosive after such a squeeze.",
    symmetrical_triangle_bullish: "A Symmetrical Triangle resolves bullish when price closes decisively above the falling resistance line. It suggests buyers won the standoff once the squeeze released.",
    symmetrical_triangle_bearish: "A Symmetrical Triangle resolves bearish when price closes decisively below the rising support line. It suggests sellers won the standoff once the squeeze released.",
    rising_wedge: "A Rising Wedge forms when a stock keeps making higher highs and higher lows, but the rally is losing steam — the lows are rising faster than the highs, so the range narrows even as price climbs. It's read as a bearish exhaustion signal, confirming once price closes decisively below the rising support line.",
    falling_wedge: "A Falling Wedge is the bullish mirror image: a stock keeps making lower highs and lower lows, but the highs are falling faster than the lows, meaning selling pressure is fading even as price still slides. It's read as a bullish exhaustion signal, confirming once price closes decisively above the falling resistance line.",
